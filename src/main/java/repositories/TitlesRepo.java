...
//////    }
//////
////    public Titles queryLatestEmpTitle(int employees) {
////        String query = "SELECT t " +
////                "FROM Titles t " +
////                "WHERE t.employees = '" + employees +
////                "' AND " +
////                "t.toDate > CURRENT_DATE";
////        return em.createQuery(query, Titles.class).getSingleResult();
////    }
////
////    public Titles insertNewEmployeeTitle(int employees, String title) {
////        LocalDate to = LocalDate.parse("31-12-9999");
////        Titles oldtitle = queryLatestEmpTitle(employees);
...
////
////        //Insert new salary
////        newTitle.setEmployees(employees);
